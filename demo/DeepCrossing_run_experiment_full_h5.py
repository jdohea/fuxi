...
from model_zoo import DeepCrossing


if __name__ == '__main__':
    # Load params from config files
    config_dir = './config/DeepCrossing_h5_config'
    experiment_id = 'full_h5_DeepCrossing' # corresponds to h5 input `data/tiny_h5`
    ...
    model = DeepCrossing(feature_map, **params)
